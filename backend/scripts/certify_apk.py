...
def certify(
    ...
    *,
    ...
    for label, spec in _operation_matrix(matrix):
        ...
        plan = create_deterministic_plan("certification", 0, request, spec, workspace)
...
def main() -> int:
    ...
    context: AbstractContextManager[str]
    if args.work_dir:
    ...
    with context as temporary:
        ...
        config = CertificationConfig(
            ...
            ai_provider="none",
            apktool_path=os.environ.get("NOIR_APKTOOL_PATH", "apktool"),
            apktool_jar=os.environ.get("NOIR_APKTOOL_JAR", ""),
            java_executable=os.environ.get("NOIR_JAVA_EXECUTABLE", "java"),
