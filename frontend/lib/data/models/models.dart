...
class AnalysisResult {
  ...
  factory AnalysisResult.fromJson(Map<String, dynamic> json) => AnalysisResult(
    ...
    obfuscationIndicators: List<String>.from(
      json['obfuscation_indicators'] ?? [],
    ),
    compatibilityWarnings: List<String>.from(
...
class FileEntry {
  ...
  factory FileEntry.fromJson(Map<String, dynamic> json) => FileEntry(
    ...
    isDirectory:
        json['is_directory'] as bool? ?? json['is_dir'] as bool? ?? false,
...
class ChangePlan {
  ...
  factory ChangePlan.fromJson(Map<String, dynamic> json) => ChangePlan(
    ...
    approved: json['review']?['approved'] == true,
    stale: json['review']?['stale'] == true,
    ...
    compatibilityConcerns: List<String>.from(
      json['compatibility_concerns'] ?? [],
    ),
